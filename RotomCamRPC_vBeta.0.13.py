...
def add_tooltip(widget, text):
    ...
    def show(_event=None):
        ...
        try:
            ...
            draw_rounded()
            canvas.bind("<Configure>", lambda _e: draw_rounded())
        except Exception:
            # Fallback to simple frame if canvas drawing fails
